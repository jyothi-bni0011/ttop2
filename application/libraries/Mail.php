...
class Mail extends PHPMailer
{
   ...
   * @return string
   */
   public function setMailBody($data, $template_html = null, $format = 'HTML',$module_name=null)
   {
      if ( !is_array($data) && $template_html == null ) {
         ...
         $templatePath = $template_html;
         if ( defined('HMVCVIEWPATH') ) {
            $views_path = HMVCVIEWPATH.$module_name.'/views/';
         } else {
            $views_path = APPPATH .'modules/';
         }
       /*   print'<pre>';
         print_r($views_path); print'<br>';
         print_r($views_path.$templatePath);
         die(); */   
