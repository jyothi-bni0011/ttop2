					...
					<div class="form-body">
						<div class="form-group row">
							<div class="col-md-10" style="text-align: right;">
								<a href="javascript:void(0);" onclick="addRow()" id="add_row_id" class="btn btn-success add_button1_0"><i class="fa fa-plus" style="padding-top:08px;"></i></a>
							</div>	
						</div>
						<div id="outer_div">
							<div class="form-group row role_group_div_0">
								...
								<div class="col-md-5">
									<select class="form-control input-height select2-multiple user_role_class" name="user_role[0][]" id="user_role_0" multiple>
...
<script type="text/javascript">
	...
	function addRow(){ 
		...
		div_content += '<div class="col-md-5"><select class="user_role_class form-control input-height select2-multiple" name="user_role['+tr_id+'][]" id="user_role_'+tr_id+'" multiple><option value="">Select User Role </option>';

			$.each(roles, function(key,value) {
			  alert(value.role_id);
			}); 
			
			/*$.each( $.parseJSON(roles), function( key, value ) {
	            div_content += "<option value="+roles[key].role_id+">"+roles[key].role_name+"</option>";
	        });*/
