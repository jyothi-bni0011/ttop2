                                         ...
                                         <tbody>
                                         	<?php $i=1; foreach($users as $user): ?>
                                         		...
                                         		<tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('admin_masters/log_history/index/').$user->{USER_ID};?>">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                         			...
                                         			<td style="display: flex;">
                                                        ...
                                                        <button class="btn btn-danger btn-tbl-delete btn-circle deactive_record" data-record_id="<?php echo $user->{USER_ID}; ?>">
                                                            <i class="fa fa-times"></i>
                                                        </button>
                                                        <?php if(!empty($assign_permissions) && in_array($user->user_roles, $assign_permissions)){
                                                        if($user->pr_supervisor_id == 0)     {
                                                        ...
                                                        <?php else: ?>
                                                            <button class="btn btn-success btn-tbl-delete btn-circle active_record" data-record_id="<?php echo $user->{USER_ID}; ?>">
